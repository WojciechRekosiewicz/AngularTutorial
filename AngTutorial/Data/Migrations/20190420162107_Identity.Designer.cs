...
namespace MovieShop.Migrations
{
    ...
    [Migration("20190420162107_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieShop.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, OrderDate = new DateTime(2019, 4, 20, 16, 21, 7, 823, DateTimeKind.Utc), OrderNumber = "77445" }
                    );
                });
            ...
            modelBuilder.Entity("MovieShop.Data.Entities.StoreUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MovieShop.Data.Entities.StoreUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MovieShop.Data.Entities.Order", b =>
                {
                    b.HasOne("MovieShop.Data.Entities.StoreUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
